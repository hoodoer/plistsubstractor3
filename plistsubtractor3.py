...
# Tweaked for python3, and not requiring .plist extension
...
def extplist(plistfile):
    ...
    try:
        ...
        print("Invalid binary plist file: " + plistfile)
        return
...
if __name__ == "__main__":
    ...
    for pfile in sys.argv[1:]:
        # Drew took this out, it's annoying having to rename plists to having an extension
        # if pfile[-6:] != ".plist":
